...
/** SAX Parser format XML
 * Pobiera BEZPOŚREDNIO ze strony nbi potrzebne dane NIE zapisuje ich do pliku
 * 
 * w metodzie Startelement ustawiamy zmienną boolean bnazwaAkapitu =true odpowiadającą <nazwaAkapitu >  <\nazwaAkapitu>
 * dzięki temu w metodzie characters możemy dostać się do zawartości akapitu. Zapisujemy te dane do pamięci. Po wykonaniu
 * zadań na wartości akapitu ustawiamy <bnazwaAkapitu=false
 *
 */
public class XMLReader extends DefaultHandler{
	   ...
	   //Arraylista dat "YYYY-MM-DD" zachowują naturalną kolejność od najwcześniejszej do najpóźniejszej
